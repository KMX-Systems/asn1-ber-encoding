...
#endif
#include "../tester.hpp"
#include <kmx/asn1/ber/decoder/printer.hpp>
...
{
    using my_tester = tester<uint32_t>;
    ...
    const my_tester::test_item_array input_items = {
        ...
        {// test4
         ...
         {// expected
          {{tag_t::sequence},
           {0x02, 0x01, 0x05, 0x16, 0x0e, 0x41, 0x6e, 0x79, 0x62, 0x6f, 0x64, 0x79, 0x20, 0x74, 0x68, 0x65, 0x72, 0x65, 0x3f}},
          {{tag_t::integer}, {0x05}},
          {{tag_t::string_ia5}, {0x41, 0x6e, 0x79, 0x62, 0x6f, 0x64, 0x79, 0x20, 0x74, 0x68, 0x65, 0x72, 0x65, 0x3f}}}},
        {// test5
         // input
         {0x30, 0x19, 0x93, 0x0A, 0x4A, 0x6F, 0x68, 0x6E, 0x20, 0x53, 0x6D, 0x69, 0x74, 0x68,
          0x93, 0x0B, 0x39, 0x38, 0x37, 0x20, 0x36, 0x35, 0x34, 0x33, 0x32, 0x31, 0x30},
         {// expected
          {{tag_t::sequence}, {0x93, 0x0A, 0x4A, 0x6F, 0x68, 0x6E, 0x20, 0x53, 0x6D, 0x69, 0x74, 0x68, 0x93,
                               0x0B, 0x39, 0x38, 0x37, 0x20, 0x36, 0x35, 0x34, 0x33, 0x32, 0x31, 0x30}},
...
namespace kmx::asn1::ber::encoder
{
    void test1();
}
...
int main()
{
    ...
    decoder::field::tag t1;
    decoder::field::tag t2;
    t2 == t1;

    decoder::field::length<> l1;
    decoder::field::length<> l2;
    l2 == l1;
