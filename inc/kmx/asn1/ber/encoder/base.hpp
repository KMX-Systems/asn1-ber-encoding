...
#pragma once
#ifndef PCH
    #include <kmx/asn1/ber/encoder/field/length.hpp>
    #include <kmx/asn1/ber/encoder/field/tag.hpp>
...
namespace kmx::asn1::ber::encoder
{
    ...
    public:
        ...
        tag_type tag() const noexcept { return tag_.value(); }

        void set_tag(const tag_type item) noexcept { tag_ = item; }
    ...
    protected:
        ...
        base(const tag_type tag = 0, const length_type length = 0) noexcept: tag_(tag), length_(length), next_(nullptr) {}
