...
#pragma once
    ...
    #include <iomanip>
    #include <iostream>
    #include <kmx/asn1/ber/decoder/tag_length.hpp>
#endif
...
namespace kmx::asn1::ber
{
    ...
    namespace decoder
    {
        ...
        public:
            printer(std::ostream& output = std::cout) noexcept: output_(&output) {}

            void reset() noexcept { padding_.clear(); }
            ...
            void print(const byte* buffer, const size_t buffer_size) { ber::print_buffer(out(), buffer, buffer_size); }
        };
    }
}
